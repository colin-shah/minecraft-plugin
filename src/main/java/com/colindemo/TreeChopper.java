...
public class TreeChopper {
    ...
    public void init(Block chest, Map<?, ?> bitConfig, Player player) {
        Bukkit.getLogger().info("Tree chopper init ");
        this.chest = chest;
    ...
    public void destroy(boolean full) {
        Bukkit.getLogger().info("Tree chopper destroy ");
        // remove armor stand
        armorStand.remove();
     ...
     */
    private void update() {
        Bukkit.getLogger().info("Tree chopper update");
    ...
    private void destroyTree() {
        Bukkit.getLogger().info("Tree chopper destroy Tree ");
        Vector tempVector = location.toVector().add(new Vector(-1, -1, -1).multiply(vector));
